...
function version(options, context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { push, remote, dryRun, trackDeps, baseBranch, noVerify, syncVersions, skipRootChangelog, skipProjectChangelog, releaseAs, preid, changelogHeader, versionTagPrefix, postTargets, commitMessageFormat, preset, allowEmptyRelease, } = _normalizeOptions(options);
      ...
      Please report an issue: https://github.com/jscutlery/semver/issues/new.`,
        ...
        const projectRoot = (0, workspace_1.getProjectRoot)(context);
        ...
        const runSemver$ = newVersion$.pipe((0, operators_1.switchMap)((newVersion) => {
            ...
            const version$ = (0, rxjs_1.defer)(() => syncVersions
                ? (0, version_1.versionWorkspace)(Object.assign(Object.assign({}, options), { skipRootChangelog }))
...
function _normalizeOptions(options) {
    var _a, _b, _c;
    return Object.assign(Object.assign({}, options), { push: options.push, remote: options.remote, dryRun: options.dryRun, trackDeps: options.trackDeps, baseBranch: options.baseBranch, noVerify: options.noVerify, syncVersions: options.syncVersions, skipRootChangelog: options.skipRootChangelog, skipProjectChangelog: options.skipProjectChangelog, allowEmptyRelease: options.allowEmptyRelease, releaseAs: (_a = options.releaseAs) !== null && _a !== void 0 ? _a : options.version, changelogHeader: (_b = options.changelogHeader) !== null && _b !== void 0 ? _b : changelog_1.defaultHeader, versionTagPrefix: (_c = options.tagPrefix) !== null && _c !== void 0 ? _c : options.versionTagPrefix, commitMessageFormat: options.commitMessageFormat, preset: options.preset === 'angular'
            ? 'angular'
            : 'conventionalcommits' });
}
